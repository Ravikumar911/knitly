...
>(({ className, ...props }, ref) => (
  <Collapsible ref={ref} className={cn("rounded-lg border", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <CollapsibleContent
    ref={ref}
    className={cn("overflow-hidden text-sm transition-all data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center px-4 py-2 text-sm text-muted-foreground", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("inline-flex items-center gap-1 rounded bg-muted px-2 py-1 text-xs font-medium", className)}
    {...props}
  />
))
