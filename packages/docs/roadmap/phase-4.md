...
- [ ] Document the package-verification story for end users (how to check the provenance attestation, verify the checksum, read the SBOM) in `README.md` or a new `reference/release.md`.
