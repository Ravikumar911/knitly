...
- [ ] Run real `gws auth login --scopes gmail.readonly` with a dedicated Google test account and confirm the consent screen lists only the Gmail read-only scope.
