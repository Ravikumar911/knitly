...
export const BaseTransactionSchema = z.object({
  ...
  // Reference IDs
  referenceIds: z.record(z.string()).default({})
  ...
  }).optional().describe("Location information for the transaction"),
});

// Extended schema with metadata and parsing info
export const BaseExtractionSchema = z.object({
  // Source metadata
  detectedProvider: z.string()
    .describe("Name of the detected financial service provider (e.g., 'Swiggy', 'PhonePe')"),
  emailType: z.enum([
    "TRANSACTION_ALERT",
    "ORDER_CONFIRMATION", 
  ...
  emailSubject: z.string()
    .describe("Original subject line of the email"),
  ...
  // Data source
  dataSource: z.enum(["EMAIL_BODY", "PDF_ATTACHMENT", "BOTH"]).optional()
  ...
  transaction: BaseTransactionSchema.optional()
    .describe("Detailed transaction information, if a transaction was detected"),
  
  // Merchant identification
  merchantId: z.string().optional()
    .describe("Internal identifier for the merchant"),
  merchantCode: z.string().optional()
    .describe("Short code for the merchant"),
});
