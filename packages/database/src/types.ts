...
export const ExtractedFinancialData = z.object({
    ...
    transaction: z.object({
      ...
      category: z.enum([
        ...
        'SUBSCRIPTION',
        'OTHER'
      ]).describe("The category of spending this transaction represents. Ensure that spends like netflix, prime, spotify, youtube etc are categorized as SUBSCRIPTION."),
