...
export const emailsRouter = createTRPCRouter({
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error getting unified sync state",
      });
    }
  }),
  // Check if user has any local seed data
  checkDataExists: protectedProcedure.query(async ({ ctx }) => {
    try {
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error checking user data",
      });
    }
  }),
  ...
  initiateSync: protectedProcedure.mutation(async ({ ctx }) => {
    try {
      const { runEmailSync } = await import(
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error initiating sync",
      });
    }
  }),

  // Get local sync progress
  getSyncProgress: protectedProcedure.query(async ({ ctx }) => {
    try {
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error getting sync progress",
      });
    }
  }),
    ...
    try {
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error refreshing emails",
      });
    }
  }),
    ...
    try {
      ...
      throw new TRPCError({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Unknown error getting sync status",
      });
    }
  }),
});
