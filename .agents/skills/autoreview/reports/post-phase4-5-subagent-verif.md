...
- Generated: 2026-06-13T07:50:40.122Z
- Branch: main
...
- fail pnpm e2e:ingest (749ms)

## Findings

- P1 Gate failed: pnpm e2e:ingest (regression, confidence 1)
  - package.json:1
  - Command exited 1. Review stdout/stderr tails in the report artifact before trusting the change.
  - Suggested fix: Fix the failing gate, rerun it, then rerun autoreview.
